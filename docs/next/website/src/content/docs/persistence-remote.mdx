...
opens a folder or picks a file, typing filters, `.` toggles hidden files, and
Esc cancels. It starts in the focused pane's working directory, and names the
setting that controls where received files land.
